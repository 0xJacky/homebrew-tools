class NginxUi < Formula
  ...
  on_macos do
    on_intel do
      ...
      sha256  "e54124970a19eb9c9ba176926e1c356da78248a53d160077cd762f27409062f6"
    end
    on_arm do
      url     "https://github.com/0xJacky/nginx-ui/releases/download/v#{version}/nginx-ui-macos-arm64-v8a.tar.gz"
      sha256  "f40a8a9ea7a644a61255b7b598183eee1b7de2f50c1b2b30838ada40fea55877"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256  "0e391c7099fe4325dda7de16fbde037a1a32b2e09e62d00dd838b9dcc7349cdb"
    end
    on_arm do
      url     "https://github.com/0xJacky/nginx-ui/releases/download/v#{version}/nginx-ui-linux-arm64-v8a.tar.gz"
      sha256  "a455db8af88a4322cdb82e9fcb899b89c8efb47b24378f3b8924fd13cb144c14"
    end
  end
